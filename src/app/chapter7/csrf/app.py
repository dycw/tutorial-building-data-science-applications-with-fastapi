...
from app.chapter7.csrf.authentication import authenticate
from app.chapter7.csrf.authentication import create_access_token
from app.chapter7.csrf.models import AccessTokenTortoise
from app.chapter7.csrf.models import User
from app.chapter7.csrf.models import UserCreate
from app.chapter7.csrf.models import UserTortoise
from app.chapter7.csrf.models import UserUpdate
from app.chapter7.csrf.password import get_password_hash
...
TORTOISE_ORM = {
    ...
    "apps": {
        "models": {
            "models": ["app.chapter7.csrf.models"],
