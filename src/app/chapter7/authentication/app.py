...
from app.chapter7.authentication.authentication import authenticate
from app.chapter7.authentication.authentication import create_access_token
from app.chapter7.authentication.models import AccessTokenTortoise
from app.chapter7.authentication.models import User
from app.chapter7.authentication.models import UserCreate
from app.chapter7.authentication.models import UserDB
from app.chapter7.authentication.models import UserTortoise
from app.chapter7.authentication.password import get_password_hash
...
TORTOISE_ORM = {
    ...
    "apps": {
        "models": {
            "models": ["app.chapter7.authentication.models"],
