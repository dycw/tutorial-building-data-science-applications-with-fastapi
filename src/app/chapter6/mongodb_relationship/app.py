...
from app.chapter6.mongodb_relationship.models import CommentCreate
from app.chapter6.mongodb_relationship.models import PostCreate
from app.chapter6.mongodb_relationship.models import PostDB
from app.chapter6.mongodb_relationship.models import PostPartialUpdate


app = FastAPI()
motor_client = AsyncIOMotorClient("mongodb://localhost:27017")  # whole server
database = motor_client[
    "chapter6_mongo_relationship"
