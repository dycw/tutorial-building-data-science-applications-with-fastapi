...
from app.chapter06.tortoise_relationship.models import CommentBase
from app.chapter06.tortoise_relationship.models import CommentDB
from app.chapter06.tortoise_relationship.models import CommentTortoise
from app.chapter06.tortoise_relationship.models import PostCreate
from app.chapter06.tortoise_relationship.models import PostDB
from app.chapter06.tortoise_relationship.models import PostPartialUpdate
from app.chapter06.tortoise_relationship.models import PostTortoise
...
TORTOISE_ORM = {
    ...
    "apps": {
        "models": {
            "models": ["app.chapter06.tortoise_relationship.models"],
