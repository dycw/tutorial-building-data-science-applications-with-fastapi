...
from app.chapter06.tortoise.models import PostCreate
from app.chapter06.tortoise.models import PostDB
from app.chapter06.tortoise.models import PostPartialUpdate
from app.chapter06.tortoise.models import PostTortoise
...
TORTOISE_ORM = {
    ...
    "apps": {
        "models": {
            "models": ["app.chapter06.tortoise.models"],
